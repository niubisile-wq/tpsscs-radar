...
The AISTAP-SIM, Dartmouth IPIX, and SSDD datasets are publicly available from their respective sources. The derived outputs, evaluation logs, and intermediate result files used in this study are stored under the project \texttt{data}, \texttt{results}, and \texttt{logs} directories.
