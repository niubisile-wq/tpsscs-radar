...
- 01_manuscript_pdf/TGRS终稿.pdf：最终投稿 PDF。
...
1. 上传 `01_manuscript_pdf/TGRS终稿.pdf` 作为 manuscript PDF。
2. 如系统要求源文件，上传 `TGRS_submission_source.zip` 或 `02_latex_source`。
...
- 未被 `TGRS终稿.tex` 引用的旧版投稿图和早期 manuscript 草稿。
