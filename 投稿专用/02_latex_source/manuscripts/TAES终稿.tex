...
The AISTAP-SIM, Dartmouth IPIX, and SSDD datasets are publicly available from their respective sources. Derived outputs, evaluation logs, intermediate results, and analysis scripts for AISTAP-SIM validation, IPIX fusion, SSDD adaptation, and bootstrap checks are archived at Zenodo (\url{https://doi.org/10.5281/zenodo.21463506}) and documented in the project repository (\url{https://github.com/niubisile-wq/tpsscs-radar}).
\begingroup
