...
- `logs/aistap_top_readiness_self_check_20260715.md` and `logs/aistap_top_readiness_self_check_20260715.json` archive the automatic CASä¸€åŒ?top readiness self-check.
