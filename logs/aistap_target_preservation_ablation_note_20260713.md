...
- Target-bearing public samples contributed 6 evaluated items.
...
- raw: Pd=0.145, target_loss=0.000 dB, clutter_attenuation=0.000 dB
- low_rank_residual: Pd=0.256, target_loss=6.191 dB, clutter_attenuation=6.955 dB
- trainable_gate: Pd=0.253, target_loss=0.197 dB, clutter_attenuation=7.594 dB
- oracle_gate: Pd=0.236, target_loss=-0.000 dB, clutter_attenuation=6.800 dB
- oracle_blend: Pd=0.359, target_loss=2.726 dB, clutter_attenuation=23.443 dB
