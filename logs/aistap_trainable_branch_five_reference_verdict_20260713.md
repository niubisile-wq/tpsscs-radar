...
| Third Batch 1 | Ahead on specificity | The branch turns the manuscript from a smoke-test scaffold into a measured trainable branch, which is a clear step up in evidence class. |
